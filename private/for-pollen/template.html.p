  ...
  <body>
    <header class="site-header">
      ...
      <div class="wrapper">
        ...
        ◊(link (config 'baseurl "/") #:class "site-title" (config 'title ""))
        ...
        <nav class="site-nav">
          ...
          <div class="trigger">
            ◊(define channels
              (or (children 'channels (get-pagetree "index.ptree"))
                  '()))
        ...
        <div class="footer-col-wrapper">
          <div class="footer-col  footer-col-1">
            <ul class="contact-list">
              <li>◊(config 'title "")</li>
              <li>◊(link (format "mailto:~a" (config 'email "")) (config 'email ""))</li>
            </ul>
          </div>

          <div class="footer-col  footer-col-2">
            <ul class="social-media-list">
              ◊when/splice[(config 'github-username)]{
                <li>
                  ◊link[(format "https://github.com/~a" (config 'github-username)]{
                    ...
                    <span class="username">◊(config 'github-username)</span>}
                </li>}

              ◊when/splice[(config 'twitter-username)]{
                <li>
                  ◊link[(format "https://twitter.com/~a" (config 'twitter-username))]{
                    ...
                    <span class="username">◊(config 'twitter-username)</span>}
                  </a>
                </li>}
            </ul>
          </div>
