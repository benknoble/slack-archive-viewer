        ...
        <div class="footer-col-wrapper">
          ...
          <div class="footer-col  footer-col-2">
            <ul class="social-media-list">
              ◊when/splice[github-username]{
                <li>
                  <a href='◊(format "https://github.com/~a" github-username)'>
                    ...
                    <span class="username">◊|github-username|</span>
                  </a>
                </li>}

              ◊when/splice[twitter-username]{
                <li>
                  <a href='◊(format "https://twitter.com/~a" twitter-username)'>
                    ...
                    <span class="username">◊|twitter-username|</span>
                  </a>
                </li>}
            </ul>
          </div>
