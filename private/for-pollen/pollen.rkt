...
(define-from-config base-url "/")
(define-from-config site-title "")
(define-from-config description "")
(define-from-config email "")
(define-from-config github-username "")
(define-from-config twitter-username "")
